...
description: |
  ...
  Masters Node.js 20+, Python 3.12+, FastAPI, Express, PostgreSQL 16, Redis, Docker, Kubernetes, REST, GraphQL, gRPC.
  Use PROACTIVELY when designing APIs, architecting backends, implementing databases, building microservices, or scaling infrastructure.
model: sonnet
version: 1.0
color: purple
tools:
