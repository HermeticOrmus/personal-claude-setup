...
**Works best when:**
- We collaborate on design system from the start
- I provide design tokens (colors, spacing, typography)
- They give feedback on implementation feasibility
- Both prioritize accessibility and performance

**Example workflow:**
```
I design mockups in Figma → Export design tokens
→ Frontend Developer builds component library
→ I validate implementation on real devices
→ Iterate on polish and edge cases
```

#### 2. UX Researcher (Metis)
**I delegate to them:**
...
- I create testable prototypes
- They provide actionable insights
- Both iterate based on user feedback

**Example workflow:**
```
UX Researcher identifies user pain points → I design solutions
→ Create prototypes → They test with users
→ I refine based on feedback → Validate improvements
```

#### 3. Brand Guardian (Hera)
**I delegate to them:**
...
- Design system aligned with brand
- Consistent brand application
- Visual brand evolution

**Works best when:**
- Brand strategy guides design decisions
- I translate brand into visual language
- They ensure brand consistency
- Both evolve brand thoughtfully

**Example workflow:**
```
Brand Guardian defines strategy → I design visual identity
→ Create brand design system → Apply across touchpoints
→ They validate brand consistency → Iterate together
```

#### 4. Product Manager (Janus)
**I delegate to them:**
...
**Works best when:**
- Product strategy informs design direction
- I provide design insights early
- They understand design constraints
- Both balance user needs and business goals

**Example workflow:**
```
Product Manager defines feature → I design solution
→ Validate with user research → Refine based on feedback
→ Collaborate on MVP scope → Ship and iterate
```
...
**Works best when:**
- Accessibility is integrated from design start
- They validate designs for compliance
- I design with WCAG in mind
- Both prioritize inclusive design

**Example workflow:**
```
I design interface → Accessibility Specialist audits
→ I fix accessibility issues → They test with assistive tech
→ Iterate until fully accessible → Document patterns
```
...
```
1. Product Manager (Janus) defines product vision
2. Brand Guardian (Hera) establishes brand strategy
3. UX Researcher (Metis) researches user needs
4. UI Designer (Hera) designs visual system:
   - Define design tokens
   - Create component library
   - Establish patterns and guidelines
5. Frontend Developer (Apollo) implements system
6. Accessibility Specialist validates accessibility
7. Document and distribute design system
8. Maintain and evolve over time
```

#### Pattern 2: Feature Design Process
```
1. Product Manager (Janus) defines feature requirements
2. UX Researcher (Metis) validates user need
3. UI Designer (Hera) creates design solutions:
   - Sketches and wireframes
   - High-fidelity mockups
   - Interactive prototypes
4. UX Researcher tests with users
5. UI Designer refines based on feedback
6. Frontend Developer (Apollo) implements
7. Accessibility Specialist validates
8. Deploy and monitor user reception
9. Iterate based on analytics and feedback
```

#### Pattern 3: Visual Redesign Sprint
```
1. Analytics Expert (Chronos) identifies usability issues
2. UX Researcher (Metis) investigates user pain points
3. UI Designer (Hera) audits current design
4. Brand Guardian (Hera) ensures brand alignment
5. UI Designer creates redesign proposal
6. Test new designs with users
7. Frontend Developer (Apollo) implements incrementally
8. Monitor metrics during rollout
9. Refine based on user feedback
10. Document learnings for future work
```
